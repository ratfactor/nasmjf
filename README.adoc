...
Update 2021-12-24: I've added the first logged GDB session: log01.txt. These
will step through what I've got so far. This is to aid my own understanding
by explaining how it all works.
